...
void main()
{
    ...
    //Instruction 0
    //SAMPLE_L
    Temp_int[0] = floatBitsToInt(textureLod(TextureBase, Input0.x, GlobalsPS.LodToSample));
    //Instruction 1
    //SAMPLE_L
    Temp_int[1] = floatBitsToInt(textureLodOffset(TextureDetail, Input0.x, GlobalsPS.LodToSample, 1));
    //Instruction 2
    //MUL
