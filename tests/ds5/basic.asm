...
//
//
//   fxc /T ds_5_0 /Fo basic.o /Fc basic.asm basic
//
//
//
...
mul r0.y, r0.x, r0.x
mul r0.z, r0.y, vDomain.x
mul r0.y, r0.y, r0.x
mul r0.xz, r0.xxzx, l(3.000000, 0.000000, 3.000000, 0.000000)
mul r1.xyz, r0.zzzz, vicp[1][0].xyzx
mad r0.yzw, r0.yyyy, vicp[0][0].xxyz, r1.xxyz
mul r1.x, vDomain.x, vDomain.x
mul r0.x, r0.x, r1.x
mul r1.x, r1.x, vDomain.x
mad r0.xyz, r0.xxxx, vicp[2][0].xyzx, r0.yzwy
mad o0.xyz, r1.xxxx, vicp[3][0].xyzx, r0.xyzx
mov o0.w, l(1.000000)
ret 
